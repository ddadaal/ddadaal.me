...
从小一直有个加入微软的梦想，终于快到实现的时候了，可是看来是时候不到，两次申请实习，苏州微软时间不合适直接没有进入面试，一次（19年1月）MSRA过了面试就等拿offer了可是[学校一纸规定断送梦想](./articles/https://viccrubs.me/articles/MSRA-DKI-frontend-interview-experiences)（可是在同时商院、计科的同学实习地不亦乐乎）。唉，“歪门邪道”是走不了了，只能去参加春招了。
