...
当时看来，项目最需要的是提高开发、测试和部署的效率，于是我从零开始

- 搭建了CI/CD和制品仓库
- 可以全自动完成的全离线、全自动的全套软件部署方案
- 用物理机搭集群，设计了复杂的网络方案确保几层内网内部的虚拟机可以用IP直连
- 开发一键式的集群部署方案，让部署开发环境从人工+2天缩短到一键+半个小时
  
客户总是有一些稀奇古怪的需求，于是

- 带着实习生做了没上线、甚至现在代码也找不到的功能
- 解决了一个没人尝试解决过的问题，结果其对环境要求苛刻，最终实际上没有环境可以使用（可能这就是为什么没有人在做这个工作吧）

除此之外，我还参与了项目开发流程设计、项目管理、公司制度、招聘和融资等管理类的工作。

每个内部基建最终都成为了项目开发不可或缺的工具，质量我也认为已不弱于大多数公司。设计的流程最终也或多或少一直发挥着作用。但放在一起，连我自己都说不清楚我究竟擅长什么，也很难让下一位面试官判断我适合什么岗位。
