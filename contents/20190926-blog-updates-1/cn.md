...
这些常见问题也写到了[simstate项目的README](https://github.com/viccrubs/simstate)中，也是给未来自己（和其他人，如果有人在用的话）带来方便，帮助解决这种常见问题。
...
5月份的时候，我尝试在[`styled-system`](https://styled-system.com/)的支持下写自己的UI库[vicui](https://github.com/viccrubs/vicui)。组件基本都完成了，但是在使用的时候遇到了[很奇怪的问题](https://github.com/viccrubs/vicui/issues/1)，造成我完全无法在其他项目中使用。
