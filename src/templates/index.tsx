...
function PageIndicator(props: {pageCount: number, current: number}) {
  ...
  return <Pagination aria-label="Page">
    <PaginationItem>
      <PaginationLink disabled={current==1} previous onClick={toPage(current-1)}/>
    </PaginationItem>
    ...
    <PaginationItem>
      <PaginationLink disabled={current==pageCount} next onClick={toPage(current+1)}/>
    </PaginationItem>
  </Pagination>
}
